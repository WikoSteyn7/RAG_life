    ...
    return (
        <div className={styles.oneshotContainer}>
            <div className={styles.oneshotTopSection}>
                ...
                <h1 className={styles.oneshotTitle}>Query your Knowledgebase</h1>
                <div className={styles.oneshotQuestionInput}>
                    <QuestionInput
                        placeholder="My name is Theodore your helpful AI assistant, ask me anything regarding funeral policies."
                        disabled={isLoading}
